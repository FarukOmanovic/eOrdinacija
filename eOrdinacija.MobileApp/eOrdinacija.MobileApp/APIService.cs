...
namespace eOrdinacija.MobileApp
{
    public class APIService
    {
...
#if DEBUG
        private string _apiUrl = "http://localhost:60126/api";
#endif
#if RELEASE
        ...
        public APIService(string route)
        {
            ...
            Client.BaseAddress = new Uri("http://localhost:60126/");
        }
        ...
        public async Task<T> Get<T>(object search)
        {
            ...
            try
            {
                ...
                var obj =  await url.WithBasicAuth(Username, Password).GetJsonAsync<T>();
        ...
        public async Task<T> GetRecommendedUsluge<T>(object id)
        {
